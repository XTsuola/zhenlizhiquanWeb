/** 金主赛选手名单：128 强来自「金主赛晋级图.xlsx」，64 强赛果来自「64强名单.xlsx」 */
...
export const roster: RosterPlayer[] = [
  { id: 1, name: "170-阿源", zhanli: 1.61, heroList: [5, 4, 11, 23], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 7, name: "43-闹笑话的绅士", zhanli: 1.18, heroList: [4, 3, 35, 7], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  { id: 8, name: "310-鱼儿", zhanli: 0.47, heroList: [3, 34, 4, 36], rounds: { "128": { results: [4, 4, 4, 4], advanced: false } } },
  { id: 9, name: "49-ZCY", zhanli: 1.26, heroList: [33, 4, 7, 17], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 3, 3, 4, 2, 3], advanced: true } } },
  ...
  { id: 14, name: "146-KB", zhanli: 1.17, heroList: [34, 3, 12, 16], rounds: { "128": { results: [1, 2, 2, 1, 1], advanced: true }, "64": { results: [3, 3, 1, 3], advanced: true } } },
  ...
  { id: 17, name: "69-伴宫星自", zhanli: 1.96, heroList: [5, 4, 7, 41], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 21, name: "354-无语没话说", zhanli: 0.95, heroList: [11, 4, 41, 5], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [2, 1, 1, 2, 1, 2, 1], advanced: true } } },
  ...
  { id: 27, name: "119-逆天", zhanli: 0.96, heroList: [6, 13, 5, 1], rounds: { "128": { results: [1, 2, 1, 1, 1], advanced: true }, "64": { results: [1, 1, 1, 2, 2, 1], advanced: true } } },
  { id: 28, name: "166-顾圆", zhanli: 0.66, heroList: [6, 13, 39, 22], rounds: { "128": { results: [2, 1, 2, 2, 2], advanced: false } } },
  { id: 29, name: "27-热血战歌", zhanli: 1.34, heroList: [3, 34, 36, 14], rounds: { "128": { results: [1, 1, 3, 3, 1], advanced: true }, "64": { results: [1, 1, 1, 2, 1], advanced: true } } },
  ...
  { id: 33, name: "354-sky", zhanli: 0.76, heroList: [5, 1, 41, 11], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 40, name: "91-李果", zhanli: 1.27, heroList: [6, 13, 1, 37], rounds: { "128": { results: [2, 2, 1, 3, 1, 1], advanced: true }, "64": { results: [1, 1, 1, 2, 1], advanced: true } } },
  { id: 41, name: "337-入眼", zhanli: 1, heroList: [4, 5, 11, 41], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 1, 1, 1], advanced: true } } },
  ...
  { id: 45, name: "397-独眼King", zhanli: 1.06, heroList: [4, 28, 35, 11], rounds: { "128": { results: [3, 2, 1, 1, 3], advanced: true }, "64": { results: [1, 2, 1, 2, 1, 2, 1], advanced: true } } },
  ...
  { id: 49, name: "41-异界淘金者", zhanli: 1.34, heroList: [5, 4, 38, 41], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 53, name: "481-星辰", zhanli: 0.64, heroList: [3, 4, 35, 7], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 57, name: "398-一只奶黄包", zhanli: 1.35, heroList: [3, 37, 32, 11], rounds: { "128": { results: [1, 1, 1, 1], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 61, name: "385-WO笑笑", zhanli: 0.91, heroList: [5, 4, 7, 41], rounds: { "128": { results: [3, 3, 2, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 2, 3], advanced: true } } },
  ...
  { id: 65, name: "393-一轮明月", zhanli: 1.51, heroList: [3, 4, 17, 34], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 72, name: "201-断罪之燚", zhanli: 0.64, heroList: [39, 22, 2, 30], rounds: { "128": { results: [4, 1, 3, 1, 4, 1], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 75, name: "157-#", zhanli: 0.72, heroList: [5, 41, 1, 13], rounds: { "128": { results: [3, 2, 3, 2, 3, 2, 3], advanced: true }, "64": { results: [3, 3, 3, 1], advanced: true } } },
  { id: 76, name: "18-達.", zhanli: 0.69, heroList: [37, 13, 6, 5], rounds: { "128": { results: [4, 1, 4, 1, 4, 1, 4], advanced: false } } },
  { id: 77, name: "337-入眼", zhanli: 0.75, heroList: [38, 29, 41, 4], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 1, 2, 1, 2, 1], advanced: true } } },
  ...
  { id: 81, name: "262-陈炜鹏", zhanli: 1.01, heroList: [3, 34, 36, 29], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 2, 3, 3, 3], advanced: true } } },
  ...
  { id: 85, name: "208-杀破猪", zhanli: 1.1, heroList: [30, 2, 22, 37], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [2, 1, 1, 2, 1, 1], advanced: true } } },
  ...
  { id: 89, name: "99-河中山", zhanli: 1.08, heroList: [3, 34, 27, 40], rounds: { "128": { results: [1, 3, 3, 3], advanced: true }, "64": { results: [1, 1, 2, 3, 1], advanced: true } } },
  ...
  { id: 95, name: "200-镇魂CSI", zhanli: 1.19, heroList: [3, 7, 4, 29], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 2, 1, 3, 2, 2, 1], advanced: true } } },
  { id: 96, name: "314-落幕", zhanli: 0.4, heroList: [9, 34, 36, 19], rounds: { "128": { results: [4, 4, 4, 4], advanced: false } } },
  { id: 97, name: "234-律师", zhanli: 2.07, heroList: [5, 41, 4, 11], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 101, name: "75-Luo", zhanli: 0.85, heroList: [30, 13, 6, 22], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 3, 3, 3], advanced: true } } },
  ...
  { id: 105, name: "149-灰企鹅", zhanli: 0.95, heroList: [38, 5, 41, 11], rounds: { "128": { results: [2, 3, 1, 2, 2, 3, 1], advanced: true }, "64": { results: [2, 3, 1, 1, 2, 3], advanced: true } } },
  ...
  { id: 109, name: "159-Jason", zhanli: 0.9, heroList: [5, 41, 4, 1], rounds: { "128": { results: [1, 3, 3, 1], advanced: true }, "64": { results: [1, 1, 1, 1], advanced: true } } },
  ...
  { id: 115, name: "200-黑曜", zhanli: 0.71, heroList: [2, 22, 37, 6], rounds: { "128": { results: [1, 3, 2, 1, 2, 3], advanced: true }, "64": { results: [3, 2, 2, 2, 3, 1, 1], advanced: true } } },
  { id: 116, name: "340-三四", zhanli: 0.59, heroList: [13, 1, 5, 41], rounds: { "128": { results: [2, 4, 1, 2, 1, 4], advanced: false } } },
  { id: 117, name: "281-太阳出来爬", zhanli: 1.05, heroList: [41, 3, 5, 1], rounds: { "128": { results: [3, 1, 1, 1], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
  ...
  { id: 124, name: "43-不如氪金", zhanli: 1.03, heroList: [4, 7, 23, 5], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [1, 2, 2, 1, 1, 1], advanced: true } } },
  { id: 125, name: "144-zwy", zhanli: 1.6, heroList: [4, 7, 41, 5], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true } } },
...
export function getPlayedRounds(p: RosterPlayer | undefined): BracketRound[] {
  if (!p) return [];
  return BRACKET_ROUNDS.filter((k) => (p.rounds[k]?.results.length ?? 0) > 0);
}
