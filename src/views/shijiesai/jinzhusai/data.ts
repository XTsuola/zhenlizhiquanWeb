/** 金主赛选手名单：128 强来自「金主赛晋级图.xlsx」，64 强赛果来自「64强名单.xlsx」，32 强赛果来自「32强名单.xlsx」，16 强赛果来自「16强名单.xlsx」 */
...
export const roster: RosterPlayer[] = [
  ...
  { id: 7, name: "43-闹笑话的绅士", zhanli: 1.18, heroList: [4, 3, 35, 7], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [1, 2, 1, 1, 1, 2, 2, 2, 1], advanced: true }, "16": { results: [1, 1, 1, 1, 2, 2, 2, 2, 1], advanced: true } } },
  ...
  { id: 17, name: "69-伴宫星自", zhanli: 1.96, heroList: [5, 4, 7, 41], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [3, 3, 3, 3, 3], advanced: true }, "16": { results: [2, 2, 1, 3, 1, 1, 1], advanced: true } } },
  ...
  { id: 45, name: "397-独眼King", zhanli: 1.06, heroList: [4, 28, 35, 11], rounds: { "128": { results: [3, 2, 1, 1, 3], advanced: true }, "64": { results: [1, 2, 1, 2, 1, 2, 1], advanced: true }, "32": { results: [1, 2, 1, 1, 2, 1, 2, 2, 1], advanced: true }, "16": { results: [1, 3, 1, 2, 1, 3], advanced: true } } },
  ...
  { id: 49, name: "41-异界淘金者", zhanli: 1.34, heroList: [5, 4, 38, 41], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [3, 3, 3, 3, 3], advanced: true }, "16": { results: [2, 2, 1, 2, 1, 2, 1, 1, 3], advanced: true } } },
  ...
  { id: 57, name: "398-一只奶黄包", zhanli: 1.35, heroList: [3, 37, 32, 11], rounds: { "128": { results: [1, 1, 1, 1], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [1, 1, 2, 1, 2, 1, 1], advanced: true }, "16": { results: [1, 1, 2, 1, 2, 1, 2, 2, 4], advanced: false } } },
  ...
  { id: 65, name: "393-一轮明月", zhanli: 1.51, heroList: [3, 4, 17, 34], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [3, 3, 3, 2, 3, 3], advanced: true }, "16": { results: [1, 1, 3, 3, 2, 1], advanced: true } } },
  ...
  { id: 81, name: "262-陈炜鹏", zhanli: 1.01, heroList: [3, 34, 36, 29], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 2, 3, 3, 3], advanced: true }, "32": { results: [1, 1, 2, 2, 1, 2, 1, 2, 1], advanced: true }, "16": { results: [1, 2, 3, 2, 1, 1, 3], advanced: true } } },
  ...
  { id: 97, name: "234-律师", zhanli: 2.07, heroList: [5, 41, 4, 11], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [3, 3, 3, 3, 3], advanced: true }, "16": { results: [3, 3, 3, 3, 3], advanced: true } } },
  ...
  { id: 125, name: "144-zwy", zhanli: 1.6, heroList: [4, 7, 41, 5], rounds: { "128": { results: [3, 3, 3, 3], advanced: true }, "64": { results: [3, 3, 3, 3], advanced: true }, "32": { results: [1, 1, 2, 1, 2, 1, 2, 1], advanced: true }, "16": { results: [1, 1, 2, 3, 1, 1], advanced: true } } },
