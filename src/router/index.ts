...
const routeList: RouteRecordRaw[] = [
  ...
  {
    path: "/gameAnalysis/playerDetail",
    name: "gameAnalysisPlayerDetail",
    component: () => import("@/views/shijiesai/gameAnalysis/index7.vue")
  },
  {
    path: "/cardsList",
    name: "cardsList",
  ...
  {
    path: "/jinzhusai/heroWR",
    name: "jinzhusaiHeroWR",
    component: () => import("@/views/shijiesai/jinzhusai/HeroWinRate.vue")
  },
  {
    path: "/jinzhusai/heroAdvance",
    name: "jinzhusaiHeroAdvance",
    component: () => import("@/views/shijiesai/jinzhusai/HeroAdvance.vue")
  },
  {
    path: "/jinzhusai/heroGold",
    name: "jinzhusaiHeroGold",
    component: () => import("@/views/shijiesai/jinzhusai/HeroGold.vue")
  },
  {
    path: "/jinzhusai/playerRank",
    name: "jinzhusaiPlayerRank",
    component: () => import("@/views/shijiesai/jinzhusai/PlayerRank.vue")
  },
  {
    path: "/game/mota",
    name: "motaGame",
